package cz.jaktoviditoka.arion.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import cz.jaktoviditoka.arion.dto.transaction.TransactionTradeRequest;
...
@EnableScheduling
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "cz.jaktoviditoka.arion.repository")
@Configuration
public class Config {
